...
void main() {
  runApp(const AllenText());
}

class AllenText extends StatefulWidget {
  const AllenText({Key? key}) : super(key: key);

  @override
  State<AllenText> createState() => _AllenTextState();
}

class _AllenTextState extends State<AllenText> {
